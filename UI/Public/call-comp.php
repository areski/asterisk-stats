...
//$FG_COL_QUERY='AsteriskStartTime, NASIPAddress, AsteriskSrc, AsteriskClid, AsteriskLastApp, AsteriskLastData, AsteriskDst, serverid, AsteriskDisposition, AsteriskDuration';
...
<!-- ** ** ** ** ** Part for the research ** ** ** ** ** -->
	...
	<INPUT TYPE="hidden" NAME="posted" value=1>
		<table class="bar-status" width="95%" border="0" cellspacing="1" cellpadding="2" align="center">
			...
			<?php
				include("date_criteria_select_laps_day.php");
			?>
...
<tbody><tr><td bgcolor="#000000">			
	...
	<?php if (FLASHCHART) { ?>
		...
		echo InsertChart ( "../lib/charts/charts.swf", "../lib/charts/charts_library", "graph_compare.php?days_compare=$days_compare&min_call=$min_call&fromstatsday_sday=$fromstatsday_sday&months_compare=$months_compare&fromstatsmonth_sday=$fromstatsmonth_sday&AsteriskDsttype=$AsteriskDsttype&sourcetype=$sourcetype&AsteriskClidtype=$AsteriskClidtype&NASIPAddress=$NASIPAddress&resulttype=$resulttype&AsteriskDst=$AsteriskDst&AsteriskSrc=$AsteriskSrc&AsteriskClid=$AsteriskClid&AsteriskUserFieldtype=$AsteriskUserFieldtype&AsteriskUserField=$AsteriskUserField&AsteriskDstCtxType=$AsteriskDstCtxType&AsteriskDstCtx=$AsteriskDstCtx", 700, 400 );
