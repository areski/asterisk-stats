...
getpost_ifset(array('typegraph', 'min_call', 'fromstatsday_sday', 'days_compare', 'fromstatsmonth_sday', 'AsteriskDsttype', 'sourcetype', 'AsteriskClidtype', 'NASIPAddress', 'resulttype', 'AsteriskDst', 'AsteriskSrc', 'AsteriskClid', 'AsteriskUserFieldtype', 'AsteriskUserField', 'AsteriskDstCtxType', 'AsteriskDstCtx', 'hourinterval'));
...
$hourintervalplus = sprintf("%02d",$hourintervalplus);
$hourinterval = sprintf("%02d",$hourinterval);

if (DB_TYPE == "postgres"){	
	if (isset($fromstatsday_sday) && isset($fromstatsmonth_sday)) 
	$date_clause.=" AND AsteriskStartTime < '$fromstatsmonth_sday-$fromstatsday_sday ".$hourintervalplus.":00:00' AND AsteriskStartTime >= '$fromstatsmonth_sday-$fromstatsday_sday ".$hourinterval.":00:00' ";
}else{
	if (isset($fromstatsday_sday) && isset($fromstatsmonth_sday)) 
	$date_clause.=" AND AsteriskStartTime < '$fromstatsmonth_sday-$fromstatsday_sday ".$hourintervalplus.":00:00' AND AsteriskStartTime >= '$fromstatsmonth_sday-$fromstatsday_sday ".$hourinterval.":00:00' ";	
}
